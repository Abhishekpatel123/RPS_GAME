...
function win(user, computer) {
    ...
    result_h1.innerHTML = ` ${convertToWord(user)}${smallUserWord}    Beat ${convertToWord(computer)}${smallComputerWord}  YOU   WIN `;
...
function lose(user, computer) {
    ...
    let smallUserWord = "user".fontsize(3).sub();
    let smallComputerWord = "comp".fontsize(3).sub();
    result_h1.innerHTML = ` ${convertToWord(user)}${smallUserWord} Loses to  ${convertToWord(computer)}${smallComputerWord}  YOU   LOSE `;
...
function draw(user, computer) {
    ...
    let smallUserWord = "user".fontsize(3).sub();
    let smallComputerWord = "comp".fontsize(3).sub();
    result_h1.innerHTML = ` ${convertToWord(user)}${smallUserWord} draw  ${convertToWord(computer)}${smallComputerWord}  MATCH DRAW `;
}
